...
document.querySelectorAll('button').forEach(button => {
    button.addEventListener('click', function(e) {
        if (this.textContent.includes('Start Free Trial') || this.textContent.includes('Get Started')) {
            e.preventDefault();
            alert('🎉 Welcome to JobAI! This is a demo website. In a real application, this would redirect to a signup page.');
        }
    });
});
...
// Uncomment the line below to add typing effect to hero title
// typeWriter(document.querySelector('.hero-title'), 'Auto-Apply Jobs on LinkedIn & Indeed with AI'); 